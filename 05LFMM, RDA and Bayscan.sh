#LMFF
plink --allow-extra-chr --vcf CPA_LD.vcf.gz  --recode --out CPA_LFMM 
#ped2lfmm
...
unzip PGDSpider_3.0.0.0.zip -d PGDSpider_3
wget https://cmpg.unibe.ch/software/BayeScan/files/BayeScan2.1.zip
unzip BayeScan2.1.zip 
cd PGDSpider_3

echo "Prepare data"
vcftools --gzvcf /PathToData/filter.snps.vcf.gz --max-missing 0.8 --maf 0.05 --max-maf 0.95 --minQ 30 --min-alleles 2 --max-alleles 2 --min-meanDP 10 --max-meanDP 100 --recode --recode-INFO-all --out EpSNP.Miss0.8MAF
java -Xmx80g -jar PGDSpider3-cli.jar -inputfile EpSNP.Miss0.8MAF.vcf -inputformat VCF -outputfile EpSNP.Miss0.8MAF_bayscan.txt -outputformat BayScan -spid TerVcfToBayscan.spid

echo "run gemma for each pheno"
./BayeScan2.1/BayeScan2.1 EpSNP.Miss0.8MAF_bayscan.txt -snp -threads 120 -od ./bayscan_result -o EpSNP_BayScan -n 5000 -thin 10 -nbp 20 -pilot 5000 -burn 50000 -pr_odds 10 -out_pilot -out_freq
